    ...
    <div className="bg-background text-foreground">
      ...
      <main className="container mx-auto py-12 px-4 md:px-6 max-w-4xl">
        <article className="prose prose-lg dark:prose-invert mx-auto">
          ...
          <p>You may use the services only if you are 18 years or older and capable of forming a binding contract with VeriFlow and are not barred from using the services under applicable law.</p>

          <h2>5. Content Ownership, Responsibility, and Removal</h2>
          <p>You are responsible for your content. You represent and warrant that you own your content or you have all rights that are necessary to grant us the license rights in your content under these Terms. You also represent and warrant that neither your content, nor your use and provision of your content to be made available through the services, nor any use of your content by VeriFlow on or through the services will infringe, misappropriate or violate a third party’s intellectual property rights, or rights of publicity or privacy, or result in the violation of any applicable law or regulation.</p>
          ...
          <ul>
            ...
            <li>Use, display, mirror or frame the services or any individual element within the services, VeriFlow’s name, any VeriFlow trademark, logo or other proprietary information, or the layout and design of any page or form contained on a page, without VeriFlow’s express written consent.</li>
            <li>Attempt to probe, scan or test the vulnerability of any VeriFlow system or network or breach any security or authentication measures.</li>
          </ul>

          <h2>7. Termination</h2>
          <p>We may terminate your access to and use of the services, at our sole discretion, at any time and without notice to you. You may cancel your account at any time by sending an email to us at [contact@veriflow.com].</p>
