...
export const metadata: Metadata = {
  title: 'LikezBuddy - Turn Your TikTok Content Into Income | Creator Monetization Platform',
  description: 'Join thousands of TikTok creators earning real money with LikezBuddy. Get paid KES 50 per 1,000 likes, access exclusive brand campaigns, and build sustainable income from your content.',
  keywords: [
  ...
  openGraph: {
    title: 'LikezBuddy - Turn Your TikTok Content Into Income',
